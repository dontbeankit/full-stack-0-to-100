...
function App() {
  ...
  <aside id="cta-button-sidebar" class="top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
...
<div className='flex-grow my-4 mx-4 grid grid-cols-3 gap-x-4 self-start'>
      
      <NextPayout title={"Next payout"} amount={"61,250.00"} orderCount={13} nextDate={"24th March"}/>
      <RevenueCard title={"Total Earning"} amount={"280,000.00"}/>
      <RevenueCard title={"Amount Pending"} amount={"93,982.20"} orderCount={13}/>
